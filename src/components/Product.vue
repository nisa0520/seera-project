  ...
  <div class="pt-0">
    ...
    <section class="relative w-full h-[320px] overflow-hidden">
      ...
      <div class="absolute inset-0 flex items-center justify-center">
        <h1 class="text-5xl font-serif text-black">Our Product</h1>
      </div>
    </section>

    <!-- MAIN WRAPPER SAMA DENGAN COLLECTIONS -->
    <div class="w-full max-w-screen-2xl mx-auto px-8 py-12">
      ...
      <div 
        v-if="showFilter"
        class="border p-6 rounded-lg mb-10 shadow-sm bg-white animate-fade w-full"
      >
...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
  ...
  >
    ...
    <div class="p-4">
      <h3 class="text-gray-900 font-semibold mb-1">{{ product.name }}</h3>
